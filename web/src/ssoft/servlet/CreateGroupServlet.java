 ...
 */
public class CreateGroupServlet extends Servlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        // 获取服务
        CreateGroupService service = BasicFactory.getFactory().getService(
        ...
        String groupName = mapContent.get("groupName");
        String type = mapContent.get("type");
        String result = service.createGroup(id, password, groupName, type);
