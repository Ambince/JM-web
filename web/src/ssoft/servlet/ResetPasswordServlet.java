 ...
 *
 */
public class ResetPasswordServlet extends Servlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String oldPassword = mapContent.get("oldPassword");
		String newPassword = mapContent.get("newPassword");
		String result = service.resetPasswrod(id, oldPassword,newPassword);
