 ...
 */
public class ReportDiaryServlet extends Servlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String reportCode = mapContent.get("reportCode");

        String result = service.reportDiary(id, password, diaryId, reportCode);
