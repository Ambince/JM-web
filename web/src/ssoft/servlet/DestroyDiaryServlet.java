 ...
 *
 */
public class DestroyDiaryServlet extends Servlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String isCheckBelong = mapContent.get("isCheckBelong");

		String result = service.destroyDiary(id, password, diaryId,isCheckBelong);
