 ...
 *
 */
public class CreateOfficialaccountServlet extends Servlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String officialaccountName = mapContent.get("officialaccountName");
		String type = mapContent.get("type");
		String coordinate = mapContent.get("coordinate");
		String messagesound = mapContent.get("messagesound");
		String result = service.createOfficialaccount(id, password, officialaccountName, type,coordinate,messagesound);
