 ...
 *
 */
public class GetOfficialaccountDiaryServlet extends Servlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String mark = "0";//获取公共评论
		String result = service.getOfficialaccountDiary(id, password, officialId,start,offset,mark);
